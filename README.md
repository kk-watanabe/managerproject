...
- 予算超過や遅延発生時のアラート機能＝＝＞早期対応をプッシュ
- 進捗率バー表示＝＝＞視認性向上化

<br>

## 今後の展望
従来のシステムのデータの蓄積があるはずである。新規システムに移行するときは、データ移行が重要な問題となると考えられる。今回のアプリではその辺りの事情を考えて設計することができなかったので、今後の展望としては、データ移行のための便利な機能の実装を行いたい。
