...
## 今後の展望
今後の展望は、従来の管理方式で分散していたデータの引継ぎを効率化することです。今回のアプリの目的は分散していたシステムを一元化することですが、新規システムに移行するとき、過去のデータの引継ぎが重要な問題となると考えられます。今回のアプリではその辺りの事情を考えて設計することができなかったので、今後はCSVのimport/exportなど、データ移行効率化のための便利な機能の実装を行いたいと考えています。<br>
また、100時間という時間の制約があったためあまりUIに凝ることができなかったのですが、ホーム画面のダッシュボード化など、よりユーザー目線で見やすく安定感のあるUIの向上を図ろうと思います。
