...
## 今後の展望
今後の展望として、従来の管理方式で分散していたデータの引継ぎを効率化することを考えています。今回のアプリの目的は分散していたシステムを一元化することですが、新規システムに移行するとき、過去のデータの引継ぎが重要な問題となると考えられます。企業実習中はその辺りの事情を考えて設計することができなかったため、今後はCSVのimport/exportなど、データ移行効率化のための便利な機能の実装を行いたいと考えています。<br>
